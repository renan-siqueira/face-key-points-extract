...
def add_margin_to_bounding_box(x_min, x_max, y_min, y_max, width, height, margin_ratio):
...
def extract_bounding_box_dlib(landmarks, num_points, image_width, image_height, margin_ratio):
    ...
    return add_margin_to_bounding_box(x_min, x_max, y_min, y_max, image_width, image_height, margin_ratio)

def extract_bounding_box_mediapipe(face_landmarks, image_shape, margin_ratio):
    ...
    return add_margin_to_bounding_box(x_min, x_max, y_min, y_max, width, height, margin_ratio)
